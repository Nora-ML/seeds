...
// withUser is a High Order Component that will recieve user/admin components as parameter,
...
const withUser = Page => {
    console.log("withUser wrap is rendered .")
    ...
    // tthrough withUser functional component as props to the Page component
